...
expect(local.includes('const BGM_OUTPUT_SCALE=0.20'),'BGM output must be reduced to 20 percent of the previous level');
...
console.log('same-origin Cyber44 + Safari gameplay SFX + 20pct BGM regression PASS');
