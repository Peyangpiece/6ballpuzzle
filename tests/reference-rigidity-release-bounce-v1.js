...
expect(result.flags.version==="rigidity-release-bounce-authority-v1"&&result.flags.busy&&result.flags.resolverBusy&&result.flags.settleBusy&&result.flags.rebase&&result.flags.pinned&&result.flags.pair,"release/bounce authority flags missing");
