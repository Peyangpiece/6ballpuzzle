...
const names=[
  ...
  'app-18.js','app-19.js','app-20.js','app-21.js','app-22.js','app-23.js','app-24.js','app-25.js','app-26.js','app-27.js','app-28.js','app-29.js','app-30.js','app-31.js','app-32.js'
];
...
if(worst.min<0.9999989)throw new Error('future-waiter lock still overlapped in seed 19: '+JSON.stringify(worst));
console.log('settled-garbage future-waiter lock PASS');
`;
