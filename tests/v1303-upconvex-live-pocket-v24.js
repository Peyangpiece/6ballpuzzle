 ...
 */
{
  ...
  expect(ctx.__sixBallUpConvexRigidImplementationVersion==="upconvex-rigidity-partial-release-v2.5","v2.5 implementation not installed");
...
console.log("v1303 live red-pocket v2.5 PASS");
