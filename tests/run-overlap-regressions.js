...
const newRuntime='"app-10.js","app-14.js","app-17.js","app-18.js"';
...
if(!source.includes(oldRuntime)){
  throw new Error("overlap regression runtime list changed; update app-18 injection explicitly");
}
...
// and execute it with the same final rotation override loaded in production.
